...
## Game Steps
 - [Combat Simulation](./CombatSubGame/Main.md)
 - JSON object creation (website?) - easy way to create new Skills, Characters, Effects, Items ect.
 - map creator
 - Full game. dialogue+quest systems
